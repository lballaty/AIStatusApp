/*
  # Complete Social Worker App Schema

  1. New Tables
    - cases
      - Tracks client cases and their status
    - appointments
      - Manages meetings between social workers and clients
    - case_notes
      - Documents interactions and observations
    - assessments
      - Stores client assessments and evaluations
    - documents
      - Manages uploaded files and documents
    - referrals
      - Tracks service referrals
    - goals
      - Tracks client goals and progress
    - resources
      - Stores information about available community resources

  2. Security
    - Enables RLS on all tables
    - Adds appropriate policies for social workers and clients
*/
